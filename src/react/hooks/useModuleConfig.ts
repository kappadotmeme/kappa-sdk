...
export function useModuleConfig(factoryAddress: string | undefined, apiBase: string) {
  ...
  const fetchModuleConfig = useCallback(async () => {
    ...
    try {
      ...
      const factoryData = data.data?.factory || data.data || data;
    ...
    try {
      ...
      if (response.ok) {
        ...
        const moduleConfig: ModuleConfig = {
          bondingContract: factoryData.packageID || factoryData.address || factoryData.packageId,
          CONFIG: factoryData.configObjectID || factoryData.configAddress || factoryData.configId,
          globalPauseStatusObjectId: factoryData.pauseStatusObjectID || factoryData.pauseStatusAddress || '0xdaa46292632c3c4d8f31f23ea0f9b36a28ff3677e9684980e4438403a67a3d8f',
          poolsId: factoryData.poolsObjectID || factoryData.poolsAddress || '0xf699e7f2276f5c9a75944b37a0c5b5d9ddfd2471bf6242483b03ab2887d198d0',
          lpBurnManger: factoryData.lpBurnManagerObjectID || factoryData.lpBurnManagerAddress || '0x1d94aa32518d0cb00f9de6ed60d450c9a2090761f326752ffad06b2e9404f845',
          moduleName: factoryData.packageName || factoryData.moduleName || 'kappadotmeme'
        };
